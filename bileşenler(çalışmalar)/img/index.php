...
<body>
    ...
    <section id="menu">
        ...
        <nav>
            ...
            <a href="#hakkimda"><i class="fas fa-user-alt ikon"></i>Hakkımda</a>
            <a href="#egitimler"><i class="fas fa-university ikon"></i>Eğitimlerim</a>
            <a href="#iletisim"><i class="fas fa-phone-alt ikon"></i>İletişim</a>
        </nav>
    </section>
